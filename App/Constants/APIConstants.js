const API_CONST = {
	...
	N_UPLOAD_PROPERTY_IMAGE_BY_ID 		: 'N_UPLOAD_PROPERTY_IMAGE_BY_ID',
	...
	N_AGENT_PROFILE_DATA				: 'N_AGENT_PROFILE_DATA',
	N_DELETE_AGENT						: 'N_DELETE_AGENT',
	...
	N_ACCEPT_OR_DENIED_MAINTENANCE_REQ	: 'N_ACCEPT_OR_DENIED_MAINTENANCE_REQ',
	
	N_COUNTER_PROPOSAL					: 'N_COUNTER_PROPOSAL',

	N_CREATE_NOTICE						: 'N_CREATE_NOTICE',

	N_ADD_POST_SUBMIT_REQUEST			: 'N_ADD_POST_SUBMIT_REQUEST',

	N_DELETE_NOTICEBOARD_POST			: 'N_DELETE_NOTICEBOARD_POST',

	N_GET_DISPUTES_LIST					: 'N_GET_DISPUTES_LIST',

	N_GET_DISPUTES_DETAILS				: 'N_GET_DISPUTES_DETAILS',

	N_GET_AGENCY_PROFILE 		    	: 'N_GET_AGENCY_PROFILE',

	N_GET_AGENCY_PROFILE_DATA			: 'N_GET_AGENCY_PROFILE_DATA',

	N_ACCEPT_DECLINE_PROPOSAL 		   	: 'N_ACCEPT_DECLINE_PROPOSAL',

	N_CONFIRM_DECLINE_COMPLETE_JOB	   	: 'N_CONFIRM_DECLINE_COMPLETE_JOB',

	N_COMPLETE_JOB					   	: 'N_COMPLETE_JOB',

	N_ADD_DISPUTES					   	: 'N_ADD_DISPUTES',
	
	N_DASHBOARD_INSPECTION				: 'N_DASHBOARD_INSPECTION',

	N_GET_STATUS_USER_ASSOCIATE_WITH_PROPERTY : 'N_GET_STATUS_USER_ASSOCIATE_WITH_PROPERTY',

	N_GET_PROPERTY_FOR_CREATE_NOTICE	: 'N_GET_PROPERTY_FOR_CREATE_NOTICE',
	N_EDIT_NOTICE_BOARD					: 'N_EDIT_NOTICE_BOARD',

	N_GET_NOTICE_BOARD_POST_DETAIL		: 'N_GET_NOTICE_BOARD_POST_DETAIL',

	N_DELETE_NOTICE_BOARD				: 'N_DELETE_NOTICE_BOARD',

	N_DELETE_MY_FILE					: 'N_DELETE_MY_FILE',

	N_ADD_RESPONCE 						: 'N_ADD_RESPONCE',

	N_GET_NOTIFICATION_STATUS			: 'N_GET_NOTIFICATION_STATUS',

	N_READ_UNREAD_MESSAGE				: 'N_READ_UNREAD_MESSAGE',

	N_UPDATE_DISPUTE_STATUS_BY_ID		: 'N_UPDATE_DISPUTE_STATUS_BY_ID',

	N_GET_ADMIN_STATASITCS				: 'N_GET_ADMIN_STATASITCS',

	N_GET_USER_ROLE_BY_ID				: 'N_GET_USER_ROLE_BY_ID'
