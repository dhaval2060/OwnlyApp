...
class TradersProfileScreen extends Component {
  ...
  onGetProfileSuccess() {
    if (this.props.tradersReducer.tradersProfileRes != "") {
      // console.log("hh "+JSON.stringify(this.props.tradersReducer.tradersProfileRes.data))
  ...
  render() {
    ...
    var businessName = this.state.profileData.business_name ? this.state.profileData.business_name 
    : "";
    ...
    // alert(JSON.stringify(this.state.profileData.business_name))
    return (
      <View>
          ...
          <View style={TradersProfileScreenStyle.profileContainer}>
            ...
            <View style={TradersProfileScreenStyle.profileDataContainer}>
              ...
              >
                ...
                {this.state.profileData.business_name  === undefined ?
                <ActivityIndicator style={{position:'absolute',height:'100%',width:'100%',zIndex:1,alignSelf:'center',backgroundColor:'transparent'}} 
      ...
      this.props.navigation.navigate('SyncittSearch',{_id:this.state.profileData._id,fromTraderProfile:'true',userData:userData})
              ...
              <View style={TradersProfileScreenStyle.userInfoContainerStyle}>
                ...
                >
                  ...
                  <Text multiline={true} numberOfLines={3} style={TradersProfileScreenStyle.infoAddStyle}>
