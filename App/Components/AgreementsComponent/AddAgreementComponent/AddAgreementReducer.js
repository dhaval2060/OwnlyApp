...
export default (state = INITIAL_STATE, action) => {
	...
	switch (action.type) {
		...
		case ACTION_TYPES.ADD_AGREEMENT_RES:

			return { ...state, addAgreementRes: action.payload, isScreenLoading: false }
		...
		case ACTION_TYPES.CLEAR_ADD_AGREEMENT_RES:
			return { ...state, addAgreementRes: action.payload}
