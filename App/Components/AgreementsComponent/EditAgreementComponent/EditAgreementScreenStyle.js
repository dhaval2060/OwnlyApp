...
export default StyleSheet.create({
	...
	pickSavedTradersLabelStyle: {
		height: 17,
		color: Colors.PICK_FROM_SAVED_TRADERS,
		fontSize: 14,
		fontWeight: '500',
		lineHeight: 17,
	},
	...
	serachListItemContainer: {
		flexDirection: 'row', borderRadius: 50, backgroundColor: 'rgba(70,164,242,0.22)', padding: 5, margin: 5, alignItems: 'center'
	},
	searchListItemImageStyle: { height: 20, width: 20, borderRadius: 10 },
	searchListItemTextStyle: { color: '#46A4F2', fontSize: 12, fontWeight: '500', padding: 5 },
	searchListItemCloseImageStyle: { height: 10, width: 10, margin: 5 },
	mainContainer: { flex: 1 },
	labelContainerStyle: { flexDirection: 'row', justifyContent: 'space-between',marginTop:15 },

	rentalCaseNumberLabelContainerStyle: {
		flexDirection: 'row', marginTop: 10, marginBottom: 15,
	},
	tenantsListContainerStyles: {
	...
	searchListItemTextStyle: { color: '#46A4F2', fontSize: 12, fontWeight: '500', padding: 5 },
	searchListItemCloseImageStyle: { height: 10, width: 10, margin: 5 },
	searchTraderListItemTextStyle: { color: '#000000', fontSize: 14, fontWeight: '500', padding: 10 ,width:window.width*0.88,},

	datePickerStyle:{
		width:window.width*0.88
	},
	rentTextInputViewStyle: {
		width: window.width * 0.4,
		height: 38,
		borderWidth: 1,
		borderColor: Colors.ADD_PROPERTY_INPUT_VIEW_COLOR,
