...
class GeneralCommunicationScreen extends React.Component {
  ...
  renderBubble(props) {
    ...
    //   />
    // );
    if (props.isSameUser && props.isSameUser(props.currentMessage, props.previousMessage) && (props.isSameDay && props.isSameDay(props.currentMessage, props.previousMessage))) {
      return (
        <Bubble
          {...props}
        />
