        ...
        return (
            <View>
                <ScrollView contentContainerStyle={{ paddingBottom: 70 }}>
                    ...
                    {
                        <ReviewAndRatingScreen totalreviews={totalreviews} reviewToName={this.state.profileData.firstname + ' ' + this.state.profileData.lastname} reviewToId={this.state.tenantId} isFrom={'TenantProfile'} />
                    }
