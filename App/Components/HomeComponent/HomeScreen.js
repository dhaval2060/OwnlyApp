    ...
    componentDidMount() {
        ...
        AsyncStorage.getItem("SyncittUserInfo").then((value) => {
            if (value) {
                ...
                this.setState({mobileCount:userData.data.reveal_contact_number})
        ...
        return (
            <View style={HomeScreenStyle.listMainContainerStyle}>
                <ScrollView contentContainerStyle={HomeScreenStyle.scrollViewStyle}>
                    ...
                    {(this.state.roleName === Strings.USER_ROLE_AGENT ||this.state.roleName === Strings.USER_ROLE_AGENCY_OWNER) ? <View style={HomeScreenStyle.noticeBoardContainerViewStyle}>
                            <Text style={HomeScreenStyle.managePropertyTextStyle}>
                                {Strings.STATISTICS}
                            </Text>
                            ...
                            <CardWithWhiteBG>
                                {/* <TouchableOpacity onPress={() => this.onStaticTabClick(Strings.TENANTS)}> */}
                                    ...
                                    <View style={HomeScreenStyle.statisticsViewContainer}>
                                        ...
                                        <Text style={HomeScreenStyle.statisticsTextStyle}>{this.state.statisticsData.tenantCnt?this.state.statisticsData.tenantCnt:''}</Text>
                                    </View>
                                {/* </TouchableOpacity> */}
                            </CardWithWhiteBG>
                            ...
                            <CardWithWhiteBG>
                                {/* <TouchableOpacity onPress={() => this.onStaticTabClick(Strings.PROPERTIES)}> */}
                                    ...
                                    <View style={HomeScreenStyle.statisticsViewContainer}>
                                        ...
                                        <Text style={HomeScreenStyle.statisticsTextStyle}>{this.state.statisticsData.propertyCnt?this.state.statisticsData.propertyCnt:''}</Text>
                                    </View>
                                {/* </TouchableOpacity> */}
                            </CardWithWhiteBG>
                            ...
                            <CardWithWhiteBG>
                                {/* <TouchableOpacity onPress={() => this.onStaticTabClick(Strings.REQUESTS)}> */}
                                    ...
                                    <View style={HomeScreenStyle.statisticsViewContainer}>
                                        ...
                                        <Text style={HomeScreenStyle.statisticsTextStyle}>{this.state.statisticsData.requestCnt?this.state.statisticsData.requestCnt:''}</Text>
                                    </View>
                                {/* </TouchableOpacity> */}
                            </CardWithWhiteBG>

                            <CardWithWhiteBG>
                                {/* <TouchableOpacity onPress={() => this.onStaticTabClick(Strings.MOBILE)}> */}
                                    <View style={HomeScreenStyle.statisticsViewContainer}>
                                        <Text style={HomeScreenStyle.statisticsLabelTextStyle}>{Strings.MOBILE}</Text>
                                        <Text style={HomeScreenStyle.statisticsTextStyle}>{this.state.mobileCount?this.state.mobileCount:''}</Text>
                                    </View>
                                {/* </TouchableOpacity> */}
                            </CardWithWhiteBG>
