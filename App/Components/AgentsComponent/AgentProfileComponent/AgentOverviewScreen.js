    ...
    render() {
        ...
        return (
            <ScrollView contentContainerStyle={{ paddingBottom: 70 }}>
                ...
                <View style={{height:0.7,backgroundColor:Colors.GRAY,marginTop:30}}/>
                ...
                <Text style={[AgentOverviewScreenStyle.detailsTextStyle,{fontWeight:'500'}]}>
                    {this.state.overViewData.agency_id.principle_id?this.state.overViewData.agency_id.principle_id.about_user:''}
                </Text>
            </ScrollView >
