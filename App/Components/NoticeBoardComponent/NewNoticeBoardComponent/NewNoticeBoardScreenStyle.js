...
export default StyleSheet.create({
  ...
  propertyRenderListStyle: {
    backgroundColor: Colors.WHITE,
    paddingLeft: 15,
    paddingRight: 15,
    paddingTop: 10
  },
  selectedPropertyRenderListStyle: {
    backgroundColor: Colors.WHITE,
    paddingTop: 10
  },
  ...
  selectedPropertyListViewStyle: {
    height: window.height * 0.2,
    backgroundColor: Colors.WHITE
  },
  propertyListSelction: {
    marginLeft: 20,
    marginRight: 20,
	marginTop: 20,
	borderRadius: 15,
