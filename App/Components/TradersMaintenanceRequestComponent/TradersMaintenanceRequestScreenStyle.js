...
export default StyleSheet.create({
  ...
  tabScrollViewStyle: { paddingRight: 20,marginTop:15 },
  deviderViewStyle: { height: 25, width: 1, backgroundColor: 'grey', marginLeft: 15 },
  requestPlaceHolerTextStyle: {
    color: Colors.BLACK,
    fontSize: 14,
    textAlign: 'center',
    justifyContent: 'center',
