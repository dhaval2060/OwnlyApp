...
import IMAGEPATH from './App/Constants/ImagesPath';
...
export default class App extends Component {
  ...
  async getToken() {
    ...
    if (!fcmToken) {
      ...
      if (fcmToken) {
        ...
        console.log("You will not recieve notifications");
      }
    }
  }
  ...
  async createNotificationListeners() {
    ...
    this.unsubscribeFromNotificationListener = firebase.notifications().onNotificationOpened((notificationOpen) => {
